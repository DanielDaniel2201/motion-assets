...
**Chat Dialog** builds a left/right conversation with editable messages, optional avatar uploads, bubble colors, font controls, reveal timing, centered reflow, and transparent MOV export.
